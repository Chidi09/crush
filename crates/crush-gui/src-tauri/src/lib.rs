...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::system::find_project_icon,
            commands::system::probe_deployment,
            ...
            commands::servers::server_container_inspect,
            ...
            commands::database::db_browse_table,
            commands::database::db_estimate_impact,
            commands::database::db_warn_unbounded,
            commands::database::db_create_sandbox,
            commands::database::db_reset_sandbox,
            commands::database::db_destroy_sandbox,
            ...
            commands::storage::storage_upload_directory,
            ...
            commands::api::api_load_spec,
            commands::api::api_import_spec,
            commands::api::api_scan_project,
            commands::api::api_probe_live,
            commands::api::api_send,
            commands::api::api_save_example,
            commands::api::api_verify_example,
            commands::api::api_verify_all,
            commands::api::api_publish_docs,
        ])
