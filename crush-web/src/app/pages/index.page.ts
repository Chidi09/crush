    ...
    <section class="py-20 sm:py-28 relative overflow-hidden">
      <div class="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-2xl text-center mb-14 select-none">
          ...
          <p class="mt-4 text-lg text-crush-textMuted">
            How Crush achieves sub-second container starts on Windows without WSL2 or Hyper-V
          </p>
        </div>
...
<span class="text-emerald-400 font-bold">✓ Bun application running natively on</span> <span class="text-sky-400 underline font-semibold">http://localhost:3000</span>
  ...
  ngOnInit(): void {
    this.title.setTitle('Crush | Native Windows Container Runtime — No WSL2 or Docker Desktop');
    this.meta.updateTag({
      name: 'description',
      content:
        'Run containers natively on Windows using Job Objects. Sub-second starts, zero VM overhead, seamless deployment to any Linux VPS. Drop-in Dockerfile replacement.',
    });
