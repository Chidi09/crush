    ...
    >
      <div class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center gap-3 ml-auto">
          <!-- Premium Search Dialog Button (Mock) -->
          <button
            class="hidden md:flex items-center justify-between gap-8 pl-3.5 pr-2.5 py-1.5 rounded-lg border border-crush-border/40 bg-crush-dark/40 hover:border-crush-orange/40 hover:bg-crush-surface/30 text-white transition-all duration-300 relative h-9 w-40 lg:w-56"
          >
